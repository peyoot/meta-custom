...
IMAGE_INSTALL:remove = " cccs connectcore-demo-example connectcore-demo-example-server connectcore-demo-example-multimedia connectcore-demo-example-webkit busybox-httpd"
