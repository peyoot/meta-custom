...
DEPENDS = "jpeg libv4l gstreamer1.0 gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad wayland wayland-protocols virtual/egl virtual/libgles2 cmake-native"
